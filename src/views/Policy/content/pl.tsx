...
export const Security = () => (
  <>
    <h2>Polityka bezpieczeństwa danych</h2>
                ...
                <h2>Kontakt</h2>
                <p>Jeśli masz pytania dotyczące bezpieczeństwa danych, skontaktuj się z nami pod:<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
  </>);
...
export const Privacy = () => (<>
    <h2>Polityka prywatności</h2>
                ...
                <h2>Kontakt</h2>
                <p>Jeśli masz jakiekolwiek pytania dotyczące tej Polityki Prywatności, skontaktuj się z nami pod adresem:<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
  </>);
...
export const Terms = () => (<>
    <h2>Warunki użytkowania</h2>
                ...
                <h2>Kontakt</h2>
                <p>Jeśli masz jakiekolwiek pytania dotyczące tych Warunków, prosimy o kontakt pod adresem:<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
  </>);
...
export const Payment = () => (<>
    <h2>Polityka płatności i zwrotów</h2>
                ...
                <p>Jeśli zakup nie powiedzie się lub zostaniesz obciążony, ale nie otrzymasz treści, najpierw spróbuj przywrócić zakupy w aplikacji. Jeśli problem będzie się utrzymywał, skontaktuj się z nami pod<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a>i będziemy badać to niezwłocznie.</p>

                <h2>Kontakt</h2>
                <p>W przypadku pytań dotyczących rozliczeń lub problemów z zakupem, skontaktuj się z nami pod:<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
