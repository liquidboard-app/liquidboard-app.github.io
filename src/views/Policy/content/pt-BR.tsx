...
export const Security = () => (
  <>
    <h2>Política de Segurança de Dados</h2>
                ...
                <h2>Contato</h2>
                <p>Se você tiver dúvidas sobre segurança de dados, entre em contato conosco:<a href="mailto:votienthuan97@gmail.com">voienthuan97@gmail.com</a></p>
  </>);
...
export const Privacy = () => (<>
    <h2>política de Privacidade</h2>
                ...
                <h2>Contato</h2>
                <p>Se você tiver alguma dúvida sobre esta Política de Privacidade, entre em contato conosco em:<a href="mailto:votienthuan97@gmail.com">voienthuan97@gmail.com</a></p>
  </>);
...
export const Terms = () => (<>
    <h2>Termos de Uso</h2>
                ...
                <h2>Contato</h2>
                <p>Se você tiver alguma dúvida sobre estes Termos, entre em contato conosco em:<a href="mailto:votienthuan97@gmail.com">voienthuan97@gmail.com</a></p>
  </>);
...
export const Payment = () => (<>
    <h2>Política de Pagamento e Reembolso</h2>
                ...
                <p>Se uma compra falhar ou você for cobrado, mas não receber o conteúdo, tente primeiro restaurar as compras no aplicativo. Se o problema persistir, entre em contato conosco em<a href="mailto:votienthuan97@gmail.com">voienthuan97@gmail.com</a>e investigaremos imediatamente.</p>

                <h2>Contato</h2>
                <p>Para dúvidas sobre faturamento ou problemas de compra, entre em contato conosco:<a href="mailto:votienthuan97@gmail.com">voienthuan97@gmail.com</a></p>
