...
export const Security = () => (
  <>
    <h2>Politica sulla Sicurezza dei Dati</h2>
                ...
                <h2>Contatto</h2>
                <p>Se avete domande sulla sicurezza dei dati, vi preghiamo di contattarci a:<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
  </>);
...
export const Privacy = () => (<>
    <h2>Informativa sulla Privacy</h2>
                ...
                <h2>Contatto</h2>
                <p>Se avete domande riguardo a questa Informativa sulla privacy, vi preghiamo di contattarci a:<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
  </>);
...
export const Terms = () => (<>
    <h2>Termini di utilizzo</h2>
                ...
                <h2>Contatto</h2>
                <p>Se avete domande su questi Termini, vi preghiamo di contattarci a:<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
  </>);
...
export const Payment = () => (<>
    <h2>Politica di Pagamento e Rimborso</h2>
                ...
                <p>Se un acquisto fallisce o ti viene addebitato ma non ricevi il contenuto, prova prima a ripristinare gli acquisti all'interno dell'App. Se il problema persiste, contattaci a<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a>e indagheremo prontamente.</p>

                <h2>Contatto</h2>
                <p>Per domande sulla fatturazione o problemi di acquisto, contattaci a:<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
