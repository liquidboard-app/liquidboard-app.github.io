...
export const Security = () => (
  <>
    <h2>Politique de sécurité des données</h2>
                ...
                <h2>Contact</h2>
                <p>Si vous avez des questions sur la sécurité des données, veuillez nous contacter à :<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
  </>);
...
export const Privacy = () => (<>
    <h2>politique de confidentialité</h2>
                ...
                <h2>Contact</h2>
                <p>Si vous avez des questions concernant cette politique de confidentialité, veuillez nous contacter à :<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
  </>);
...
export const Terms = () => (<>
    <h2>Conditions d'utilisation</h2>
                ...
                <h2>Contact</h2>
                <p>Si vous avez des questions concernant ces Conditions, veuillez nous contacter à :<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
  </>);
...
export const Payment = () => (<>
    <h2>Politique de paiement et de remboursement</h2>
                ...
                <p>Si un achat échoue ou si vous êtes facturé mais ne recevez pas le contenu, essayez d'abord de restaurer les achats dans l'application. Si le problème persiste, contactez-nous au<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a>et nous enquêterons rapidement.</p>

                <h2>Contact</h2>
                <p>Pour des questions de facturation ou des problèmes d'achat, contactez-nous à :<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
