...
export const Security = () => (
  <>
    <h2>Datensicherheitsrichtlinie</h2>
                ...
                <h2>Kontakt</h2>
                <p>Wenn Sie Fragen zum Datenschutz haben, kontaktieren Sie uns bitte unter:<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
  </>);
...
export const Privacy = () => (<>
    <h2>Datenschutzrichtlinie</h2>
                ...
                <h2>Kontakt</h2>
                <p>Wenn Sie Fragen zu dieser Datenschutzrichtlinie haben, kontaktieren Sie uns bitte unter:<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
  </>);
...
export const Terms = () => (<>
    <h2>Nutzungsbedingungen</h2>
                ...
                <h2>Kontakt</h2>
                <p>Wenn Sie Fragen zu diesen Bedingungen haben, kontaktieren Sie uns bitte unter:<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
  </>);
...
export const Payment = () => (<>
    <h2>Zahlungs- und Rückerstattungsrichtlinien</h2>
                ...
                <p>Wenn ein Kauf fehlschlägt oder Ihnen eine Gebühr berechnet wird, Sie den Inhalt aber nicht erhalten, versuchen Sie bitte zunächst, Käufe in der App wiederherzustellen. Wenn das Problem weiterhin besteht, kontaktieren Sie uns unter<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a>und wir werden umgehend nachforschen.</p>

                <h2>Kontakt</h2>
                <p>Bei Rechnungsfragen oder Kaufproblemen kontaktieren Sie uns unter:<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
