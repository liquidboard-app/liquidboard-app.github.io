...
export const Security = () => (
  <>
    <h2>Chính sách Bảo mật Dữ liệu</h2>
                ...
                <h2>Liên hệ</h2>
                <p>Nếu bạn có thắc mắc về bảo mật dữ liệu, vui lòng liên hệ với chúng tôi tại: <a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
  </>
);
...
export const Privacy = () => (
  <>
    <h2>Chính sách Quyền riêng tư</h2>
                ...
                <h2>Liên hệ</h2>
                <p>Nếu bạn có bất kỳ câu hỏi nào về Chính sách Quyền riêng tư này, vui lòng liên hệ với chúng tôi tại: <a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
  </>
);
...
export const Terms = () => (
  <>
    <h2>Điều khoản Sử dụng</h2>
                ...
                <h2>Liên hệ</h2>
                <p>Nếu bạn có bất kỳ câu hỏi nào về các Điều khoản này, vui lòng liên hệ với chúng tôi tại: <a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
  </>
);
...
export const Payment = () => (
  <>
    <h2>Chính sách Thanh toán & Hoàn tiền</h2>
                ...
                <p>Nếu giao dịch mua bị lỗi hoặc bạn đã bị tính phí nhưng không nhận được nội dung, trước tiên hãy thử khôi phục lại các giao dịch mua trong Ứng dụng. Nếu sự cố vẫn tiếp diễn, vui lòng liên hệ với chúng tôi tại <a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a> và chúng tôi sẽ nhanh chóng điều tra.</p>

                <h2>Liên hệ</h2>
                <p>Đối với các câu hỏi về thanh toán hoặc các vấn đề mua hàng, hãy liên hệ với chúng tôi tại: <a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
