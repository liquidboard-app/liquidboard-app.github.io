...
export const Security = () => (
  <>
    <h2>Kebijakan Keamanan Data</h2>
                ...
                <h2>Kontak</h2>
                <p>Jika Anda memiliki pertanyaan tentang keamanan data, silakan hubungi kami di:<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
  </>);
...
export const Privacy = () => (<>
    <h2>Kebijakan Privasi</h2>
                ...
                <h2>Kontak</h2>
                <p>Jika Anda memiliki pertanyaan tentang Kebijakan Privasi ini, silakan hubungi kami di:<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
  </>);
...
export const Terms = () => (<>
    <h2>Syarat Penggunaan</h2>
                ...
                <h2>Kontak</h2>
                <p>Jika Anda memiliki pertanyaan tentang Ketentuan ini, silakan hubungi kami di:<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
  </>);
...
export const Payment = () => (<>
    <h2>Kebijakan Pembayaran & Pengembalian</h2>
                ...
                <p>Jika pembelian gagal atau Anda dikenakan biaya tetapi tidak menerima kontennya, harap coba terlebih dahulu memulihkan pembelian di dalam Aplikasi. Jika masalah berlanjut, hubungi kami di<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a>dan kami akan menyelidiki dengan segera.</p>

                <h2>Kontak</h2>
                <p>Untuk pertanyaan penagihan atau masalah pembelian, hubungi kami di:<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
