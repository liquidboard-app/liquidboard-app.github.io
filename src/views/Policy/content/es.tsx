...
export const Security = () => (
  <>
    <h2>Política de seguridad de datos</h2>
                ...
                <h2>Contacto</h2>
                <p>Si tiene preguntas sobre la seguridad de los datos, contáctenos en:<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
  </>);
...
export const Privacy = () => (<>
    <h2>política de privacidad</h2>
                ...
                <h2>Contacto</h2>
                <p>Si tiene alguna pregunta sobre esta Política de Privacidad, contáctenos en:<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
  </>);
...
export const Terms = () => (<>
    <h2>Condiciones de uso</h2>
                ...
                <h2>Contacto</h2>
                <p>Si tiene alguna pregunta sobre estos Términos, contáctenos en:<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
  </>);
...
export const Payment = () => (<>
    <h2>Política de pago y reembolso</h2>
                ...
                <p>Si una compra falla o se le cobra pero no recibe el contenido, primero intente restaurar las compras dentro de la aplicación. Si el problema persiste, contáctenos al<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a>y lo investigaremos con prontitud.</p>

                <h2>Contacto</h2>
                <p>Para preguntas de facturación o problemas de compra, contáctenos en:<a href="mailto:votienthuan97@gmail.com">votienthuan97@gmail.com</a></p>
