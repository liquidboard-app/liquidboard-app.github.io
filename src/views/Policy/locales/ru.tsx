...
export const Security = () => (
  <>
    <h2>Политика безопасности данных</h2>
                ...
                <h2>Контакт</h2>
                <p>Если у вас есть вопросы о безопасности данных, свяжитесь с нами по адресу:<a href="mailto:liquidboard.app@gmail.com">liquidboard.app@gmail.com</a></p>
  </>);
...
export const Privacy = () => (<>
    <h2>политика конфиденциальности</h2>
                ...
                <h2>Контакт</h2>
                <p>Если у вас есть какие-либо вопросы по поводу настоящей Политики конфиденциальности, свяжитесь с нами по адресу:<a href="mailto:liquidboard.app@gmail.com">liquidboard.app@gmail.com</a></p>
  </>);
