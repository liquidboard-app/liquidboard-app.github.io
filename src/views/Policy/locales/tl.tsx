...
export const Security = () => (
  <>
    <h2>Patakaran sa Seguridad ng Datos</h2>
                ...
                <p>Kung mayroon kang mga katanungan tungkol sa seguridad ng datos, mangyaring makipag-ugnayan sa amin sa:<a href="mailto:liquidboard.app@gmail.com">liquidboard.app@gmail.com</a></p>
  </>);
...
export const Privacy = () => (<>
    <h2>Patakaran sa Pagkapribado</h2>
                ...
                <h2>Makipag-ugnayan</h2>
                <p>Kung mayroon kayong anumang mga katanungan tungkol sa Patakaran sa Pagkapribado na ito, mangyaring makipag-ugnayan sa amin sa:<a href="mailto:liquidboard.app@gmail.com">liquidboard.app@gmail.com</a></p>
  </>);
...
export const Terms = () => (<>
    <h2>Mga Tuntunin ng Paggamit</h2>
                ...
                <h2>Makipag-ugnayan</h2>
                <p>Kung mayroon kang anumang mga katanungan tungkol sa Mga Tuntuning ito, mangyaring makipag-ugnayan sa amin sa:<a href="mailto:liquidboard.app@gmail.com">liquidboard.app@gmail.com</a></p>
  </>);
...
export const Payment = () => (<>
    <h2>Patakaran sa Pagbabayad at Pagrefund</h2>
                ...
                <p>Kung nabigo ang isang pagbili o nakasawsaw ka ng bayad ngunit hindi natanggap ang nilalaman, mangyaring subukang i-restore muna ang mga pagbili sa loob ng App. Kung nagpapatuloy ang problema, makipag-ugnayan sa amin sa<a href="mailto:liquidboard.app@gmail.com">liquidboard.app@gmail.com</a>at mag-iimbestiga kami agad.</p>

                <h2>Makipag-ugnayan</h2>
                <p>Para sa mga tanong tungkol sa pagsingil o mga isyu sa pagbili, makipag-ugnayan sa amin sa:<a href="mailto:liquidboard.app@gmail.com">liquidboard.app@gmail.com</a></p>
