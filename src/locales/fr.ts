...
const fr: LocaleDict = {
  ...
  actionClipboard: {
    ...
    voiceTitle: 'Voix',
    voiceDescription: 'De l’audio au texte',
    scanTitle: 'Scanner',
    scanDescription: 'Importer tout le texte trouvé',
    clipboardTitle: 'Presse-papiers système',
    clipboardDescription: 'Copier depuis n’importe où',
    icloudTitle: 'iCloud',
    icloudDescription: 'Gardez votre presse-papiers dans le cloud',
