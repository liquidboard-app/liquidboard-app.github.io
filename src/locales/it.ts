...
const it: LocaleDict = {
  ...
  hero: {
    ...
    line2: { left: "nella tua", right: "Tastiera" },
  },
  header: {
    ...
    plans: [
      {
        ...
        price: '€0',
        description: 'Per utenti di prova',
      ...
      },
      {
        ...
        lifetime: 'Accesso a vita',
        price: '€2.99',
        description: 'Per utenti occasionali',
      ...
      },
      {
        ...
        lifetime: 'Accesso a vita',
        price: '€5.99',
        description: 'Per utenti multitasking',
      ...
      },
      {
        ...
        lifetime: 'Accesso a vita',
        price: '€10.99',
        description: 'Per utenti professionali',
