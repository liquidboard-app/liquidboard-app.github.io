...
const en: LocaleDict = {
  ...
  actionClipboard: {
    ...
    voiceTitle: 'Voice',
    voiceDescription: 'From sound to text',
    scanTitle: 'Scan',
    scanDescription: 'Import all text found',
    clipboardTitle: 'System Pasteboard',
    clipboardDescription: 'Copy from anywhere',
    icloudTitle: 'iCloud',
    icloudDescription: 'Keep your clipboard in the cloud',
