...
const bn: LocaleDict = {
  ...
  actionClipboard: {
    ...
    headingTitle: 'সম্পূর্ণ কাস্টমাইজেশন',
    headingDescription: 'আপনার পছন্দমতো প্রতিটি ক্লিপবোর্ড তৈরি করুন',
    ...
    voiceTitle: 'ভয়েস',
    voiceDescription: 'অডিও থেকে টেক্সটে',
    scanTitle: 'স্ক্যান',
    scanDescription: 'পাওয়া সমস্ত টেক্সট ইমপোর্ট করুন',
    clipboardTitle: 'সিস্টেম ক্লিপবোর্ড',
    clipboardDescription: 'যেকোনো জায়গা থেকে কপি করুন',
    icloudTitle: 'iCloud',
    icloudDescription: 'ক্লিপবোর্ড ক্লাউডে রাখুন',
