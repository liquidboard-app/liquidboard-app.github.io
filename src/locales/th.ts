...
const th: LocaleDict = {
  ...
  actionClipboard: {
    ...
    voiceTitle: 'เสียง',
    voiceDescription: 'จากเสียงเป็นข้อความ',
    scanTitle: 'สแกน',
    scanDescription: 'นำเข้าข้อความที่พบทั้งหมด',
    clipboardTitle: 'คลิปบอร์ดระบบ',
    clipboardDescription: 'คัดลอกจากทุกที่',
    icloudTitle: 'iCloud',
    icloudDescription: 'เก็บคลิปบอร์ดไว้บนคลาวด์',
