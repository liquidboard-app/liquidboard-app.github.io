...
const tr: LocaleDict = {
  ...
  actionClipboard: {
    ...
    voiceTitle: 'Ses',
    voiceDescription: 'Sesten metne',
    scanTitle: 'Tara',
    scanDescription: 'Bulunan tüm metni içe aktar',
    clipboardTitle: 'Sistem panosu',
    clipboardDescription: 'Her yerden kopyala',
    icloudTitle: 'iCloud',
    icloudDescription: 'Panoyu bulutta tutun',
