...
const de: LocaleDict = {
  ...
  actionClipboard: {
    ...
    voiceTitle: 'Sprache',
    voiceDescription: 'Von Audio zu Text',
    scanTitle: 'Scannen',
    scanDescription: 'Gesamten gefundenen Text importieren',
    clipboardTitle: 'System-Zwischenablage',
    clipboardDescription: 'Von überall kopieren',
    icloudTitle: 'iCloud',
    icloudDescription: 'Clipboard in der Cloud behalten',
