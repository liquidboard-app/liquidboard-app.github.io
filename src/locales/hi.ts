...
const hi: LocaleDict = {
  ...
  actionClipboard: {
    ...
    shareDescription: 'हर प्लेटफ़ॉर्म पर भेजें',
    exportTitle: 'आयात / निर्यात',
    exportDescription: 'JSON या CSV के साथ सहेजें और आयात करें',
    voiceTitle: 'आवाज़',
    voiceDescription: 'ऑडियो से टेक्स्ट तक',
    scanTitle: 'स्कैन',
    scanDescription: 'मिला हुआ सारा टेक्स्ट आयात करें',
    clipboardTitle: 'सिस्टम क्लिपबोर्ड',
    clipboardDescription: 'कहीं से भी कॉपी करें',
    icloudTitle: 'iCloud',
    icloudDescription: 'क्लिपबोर्ड को क्लाउड में रखें',
