...
const pl: LocaleDict = {
  ...
  actionClipboard: {
    ...
    voiceTitle: 'Głos',
    voiceDescription: 'Z dźwięku na tekst',
    scanTitle: 'Skanuj',
    scanDescription: 'Importuj cały znaleziony tekst',
    clipboardTitle: 'Schowek systemowy',
    clipboardDescription: 'Kopiuj z dowolnego miejsca',
    icloudTitle: 'iCloud',
    icloudDescription: 'Przechowuj schowek w chmurze',
