...
const tl: LocaleDict = {
  ...
  actionClipboard: {
    ...
    voiceTitle: 'Boses',
    voiceDescription: 'Mula audio tungo sa text',
    scanTitle: 'I-scan',
    scanDescription: 'I-import ang lahat ng nakitang text',
    clipboardTitle: 'System Pasteboard',
    clipboardDescription: 'Kumopya kahit saan',
    icloudTitle: 'iCloud',
    icloudDescription: 'Panatilihin ang clipboard sa cloud',
