...
const ptBR: LocaleDict = {
  ...
  actionClipboard: {
    ...
    voiceTitle: 'Voz',
    voiceDescription: 'Do áudio ao texto',
    scanTitle: 'Digitalizar',
    scanDescription: 'Importe todo o texto encontrado',
    clipboardTitle: 'Área de transferência do sistema',
    clipboardDescription: 'Copie de qualquer lugar',
    icloudTitle: 'iCloud',
    icloudDescription: 'Mantenha sua área de transferência na nuvem',
