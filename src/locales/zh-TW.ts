...
const zhTW: LocaleDict = {
  ...
  actionClipboard: {
    ...
    shareDescription: '傳送到所有平台',
    exportTitle: '匯入 / 匯出',
    exportDescription: '使用 JSON 或 CSV 儲存與匯入',
    voiceTitle: '語音',
    voiceDescription: '從音訊到文字',
    scanTitle: '掃描',
    scanDescription: '匯入找到的所有文字',
    clipboardTitle: '系統剪貼簿',
    clipboardDescription: '從任何地方複製',
    icloudTitle: 'iCloud',
    icloudDescription: '將剪貼簿保存在雲端',
